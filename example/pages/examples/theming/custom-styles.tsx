    ...
    <>
      ...
      <div>
        <small className={styles.info}>
          This example is styled with an <code>&lt;style jsx global&gt;&lt;/style&gt;</code> tag.
          This is not recommended for production use, but since you cannot import global styles in a
      ...
      <div>
        <small className={styles.info}>
          A tip is to inspect the DOM. All the stylable classes on the respective elements are
          visible with the basic styles applied.
        </small>
      </div>
